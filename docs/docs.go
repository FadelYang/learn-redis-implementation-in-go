...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "request body for logout user [RAW]",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/common.BaseResponse-string"
                        }
                    }
                }
            }
        ...
        "/auth/refresh": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "request body for refresh access token [RAW]",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/common.BaseResponse-dto_RefreshResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "common.BaseResponse-dto_RefreshResponse": {
            "type": "object",
            "properties": {
                "data": {
